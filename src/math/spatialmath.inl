...
extern inline svec6 crossm(const svec6& v1, const svec6& v2);
extern inline svec6 crossf(const svec6& v1, const svec6& v2);
...
svec6 crossf(const svec6& v1, const svec6& v2){
	return svec6(-v1[2] * v2[1] + v1[1] * v2[2] - v1[5] * v2[4] + v1[4] * v2[5],
...
svec6 crossm(const svec6& v1, const svec6& v2){
	return svec6(-v1[2] * v2[1] + v1[1] * v2[2],
				  v1[2] * v2[0] - v1[0] * v2[2],
				 -v1[1] * v2[0] + v1[0] * v2[1],
